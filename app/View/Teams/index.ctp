<div class="teams index">
	...
	<tr>
		...
		<td><?php echo $this->HTML->image($team['Team']['logo'],array('width'=>'50px'));?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($team['Country']['title'], array('controller' => 'countries', 'action' => 'view', $team['Country']['id'])); ?>
		</td>
		<td class="actions">
