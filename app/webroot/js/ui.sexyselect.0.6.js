    ...
    $.widget("ui.sexyselect", {
        ...
        _init: function(){
            ...
            this.sselect = $(self.el.d)
                           .css({'height': ((!options.expanded && options.allowCollapse) ? 28 : (!options.allowInput ? 28 - options.height : options.height)) + 'px', 'width' : options.width + 'px', 'background' : options.background, 'padding' : '0', 'margin' : '0', 'position':'relative'})
            ...
            if(options.showTitle)
            {
                ...
                if(options.allowCollapse)
                {
                    ...
                    this.header.append($(self.el.s)
                                       .css({'width' : options.width - 40 + 'px', 'display':'inline-block'})
                                       .html(options.title)
            ...
            this.itemHolder = $(self.el.d)
                            //.css({'height': options.height - (options.showTitle ? 53 : 22) + 'px', 'width' : options.width ,'overflow-y' : 'auto', 'margin' : '0px' , 'padding' : '0px'})
                            .css({'height': '200px', 'width' : options.width ,'overflow-y' : 'auto', 'margin' : '0px' , 'padding' : '0px'})
